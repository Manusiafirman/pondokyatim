...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <h1 class="logo me-auto me-lg-0"><a href="frontend.index">YAYASAN PONDOK YATIM</a></h1>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Firman Romansyah & Adya Eka Amelia</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
